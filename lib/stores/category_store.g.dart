...
mixin _$CategoryStore on _CategoryStoreBase, Store {
  Computed<List<CategoryModel>>? _$allCategoriesComputed;

  @override
  List<CategoryModel> get allCategories => (_$allCategoriesComputed ??=
          Computed<List<CategoryModel>>(() => super.allCategories,
              name: '_CategoryStoreBase.allCategories'))
      .value;
